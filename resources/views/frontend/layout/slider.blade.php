  ...
  nav-dark nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 9000}" style="height: 100vh;">
    <div class="owl-stage-outer">
        <div class="owl-stage">
            ...
            <div class="owl-item position-relative pt-5 overlay overlay-show overlay-op-7" style="background-image: url(/banner1.jpg); background-size: cover; background-position: center;">
                <div class="container position-relative z-index-3 pb-5 h-100">
                    <div class="row align-items-center pb-5 h-100">
                        <div class="col">
                            ...
                            <br>
                            <a href="{{ route('contactus') }}" class="btn btn-primary btn-modern font-weight-bold text-2 py-3 btn-px-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">İLETİŞİME GEÇ</a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="owl-item position-relative pt-5 overlay overlay-show overlay-op-7" style="background-image: url(/kaygi-anksiyete-bozukluklari.jpg); background-size: cover; background-position: center;">
                <div class="container position-relative z-index-3 pb-5 h-100">
                    <div class="row align-items-center pb-5 h-100">
                        <div class="col">
                            <h2 class="custom-secondary-font text-color-light font-weight-extra-bold text-8 line-height-1 line-height-sm-3 mb-1
                            ...
                            <br>
                            <a href="{{ route('servicedetail', 'kaygi-anksiyete-bozukluklari') }}" class="btn btn-primary btn-modern font-weight-bold text-2 py-3 btn-px-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">İLETİŞİME GEÇ</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-item position-relative pt-5 overlay overlay-show overlay-op-7" style="background-image: url(/depresyon.jpg); background-size: cover; background-position: center;">
                <div class="container position-relative z-index-3 pb-5 h-100">
                    <div class="row align-items-center pb-5 h-100">
                        <div class="col">
                            <h2 class="custom-secondary-font text-color-light font-weight-extra-bold text-8 line-height-1 line-height-sm-3 mb-1
                ...
                <div class="container position-relative z-index-3 pb-5 h-100">
                    <div class="row align-items-center pb-5 h-100">
                        <div class="col">
                            ...
                            <br>
                            <a href="{{ route('servicedetail', 'dikkat-eksikligi-hiperaktivite-bozuklugu') }}" class="btn btn-primary btn-modern font-weight-bold text-2 py-3 btn-px-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">İLETİŞİME GEÇ</a>
                        </div>
                    </div>
                </div>
            </div>
...
{{--
                    <p class="text-white">and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
--}}
                </div>
            </div>
            <div class="col-md-3 d-flex justify-content-md-end mb-4 mb-md-0">
                <a class="text-decoration-none" href="tel:0530 500 97 40" target="_blank" title="Hemen Arayın">
                    <span class="custom-call-to-action">
                        <span class="action-title text-white">Telefon Numarası</span>
                        <span class="action-info text-color-light">0530 500 97 40</span>
                    </span>
                </a>
            </div>

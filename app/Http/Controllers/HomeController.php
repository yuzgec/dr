...
class HomeController extends Controller
{
    ...
    public function index(){
        SEOMeta::setTitle('Suadiye Psikiyatrist Uzman Dr. Turan Çetin');
    ...
    public function servicedetail($url){
        ...
        SEOMeta::setTitle($Detail->title. ' | Suadiye Psikiyatrist Ve Psikoterapist Uzm. Dr. Turan Çetin');
    ...
    public function blogdetail($url){
        ...
        SEOMeta::setTitle($Detail->title. ' | Suadiye Psikiyatrist Uzm. Dr. Turan Çetin');
        SEOMeta::setDescription($Detail->title. ' | Psikiyatrist Ve Psikoterapist Uzm. Dr. Turan Çetin');
        SEOMeta::setCanonical(url()->full());
    ...
    public function video(){
        ...
        SEOMeta::setTitle('Video Galeri | Suadiye Psikiyatrist Uzm. Dr. Turan Çetin');
        SEOMeta::setDescription('Psikiyatrist Ve Psikoterapist Uzm. Dr. Turan Çetin');
        SEOMeta::setCanonical(url()->full());
